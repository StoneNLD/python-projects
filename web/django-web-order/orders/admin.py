...
from .models import Category, RegularPizza, SicilianPizza, Toppings, Sub, Pasta, Salad, Kaasplankje, DinnerPlatters, UserOrder, SavedCarts
...
admin.site.register(Kaasplankje)